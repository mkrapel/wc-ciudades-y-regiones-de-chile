    ...
    if ( ! class_exists( 'Filters_By_Cities_Method_CL' ) ) {
        class Filters_By_Cities_Method_CL extends WC_Shipping_Method {
            ...
            public function __construct($instance_id = 0) {
                ...
                $this->method_title       	= __( 'Despacho por Ciudad');
                $this->method_description 	= __( 'Selecciona las Ciudades de la Región ingresado como <strong>"Zona de Envío"</strong>, recuerda que el <strong>Nombre del Tipo de Envío</strong> es el que se mostrará a tus compradores al momento de seleccionar el medio de pago deseado. <strong>Recuerda que seleccionar "No" como "Método de Envío Único" permites que puedan funcionar los otros tipos de Métodos de Envío establecidos con anterioridad</strong>');
                $this->supports = array(
                    'settings',
                    'shipping-zones',
                    'instance-settings'
