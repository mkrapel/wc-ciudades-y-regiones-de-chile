    ...
    if ( ! class_exists( 'Filters_By_Cities_Method' ) ) {
        ...
        class Filters_By_Cities_Method extends WC_Shipping_Method
        {
            ...
            public function __construct($instance_id = 0)
            {
                ...
                $this->method_title       = __( 'Despachos por Ciudad', 'wc-ciudades-y-regiones-de-chile' );
                $this->method_description = __( 'Selecciona las comunas de la Región ingresada como <strong>"Zona de Envío"</strong>, recuerda que el <strong>Nombre del Tipo de Envío</strong> es el que se mostrará a tus compradores al momento de seleccionar el medio de pago deseado. <strong>Recuerda que seleccionar "No" como "Método de Envío Único" permites que puedan funcionar los otros tipos de Métodos de Envío establecidos con anterioridad</strong>', 'wc-ciudades-y-regiones-de-chile' );
            ...
            public function showCitiesRegions()
            {
                ...
                foreach ($zones as $zone){
                    if (strpos($zone->code, ':') !== false){
                        ...
                        $states = WC_Ciudades_Regiones_Chile::get_places( $place[0] );
